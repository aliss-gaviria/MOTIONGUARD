...
#define ADC_VOLTAJE   ADC1_CHANNEL_7  
#define R1 10000.0
#define R2 10000.0
...
void onMonitoring() {
  ...
  // reset batería al iniciar ciclo
  sumaVoltaje = 0;
  contadorMuestras = 0;
